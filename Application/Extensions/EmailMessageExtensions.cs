...
public static class EmailMessageExtensions
{
        ...
        PageKey key)
    {
        ...
        // Step 2
        message.Subject = message.Subject.Replace(Variables.PAGE_TOKEN, key.Value.ToString());
        ...
        message.HtmlBody = message.HtmlBody.Replace(Variables.PAGE_TOKEN, key.Value.ToString());
        ...
        message.TextBody = message.TextBody.Replace(Variables.PAGE_TOKEN, key.Value.ToString());
